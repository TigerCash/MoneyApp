...
public class MoneyAppContentProvider extends ContentProvider {
	...
	static {
		...
		sURIMatcher.addURI(AUTHORITY, BASE_PATH_TRANSACTION_PORTION, TRANSACTION_PORTIONS);
		sURIMatcher.addURI(AUTHORITY, BASE_PATH_TRANSACTION_PORTION + "/#", TRANSACTION_PORTION_ID);
